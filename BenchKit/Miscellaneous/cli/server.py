...
class ModelRuns:
    ...
    @staticmethod
    def _convert_tracker_config(tracker_row: dict) -> tuple[dict, list[dict], dict, str, str]:
        """
    ...
    @staticmethod
    def get_model_runs_table_contents(evaluation_criteria: str | int,
                                      sort_by: str,
                                      ascending: bool,
        ...
        while True:
            ...
            forward = yield (rows, model_state_list, model_save_list,
                             server_id_list, tracker_config_id_list, next_page,
                             headers)
...
class ModelState:
    ...
    def show_and_download_states(model_state_list: dict, experiment_name) -> None:
        ...
        ModelState._download_model_state(state_id_list[checkpoint_number], experiment_name)
    ...
    @staticmethod
    def _download_model_state(model_state_id: str,
