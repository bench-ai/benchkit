...
from benchkit.data import BaseFile
from benchkit.data import BooleanFile
from benchkit.data import get_test_dataloader
from benchkit.data import IterableChunk
from benchkit.data import JsonFile
from benchkit.data import NumericFile
from benchkit.data import NumpyFile
from benchkit.data import ProcessorDataset
from benchkit.data import RawFile
from benchkit.data import save_file_and_label
from benchkit.data import TextFile
from benchkit.data import TorchFile
...
class MultiClassTestProcessor(ProcessorDataset):
    ...
    def _get_data(self, idx: int):
        self.nf1.append(
            ...
            if (idx % 2) == 0
            else float(random.randint(1, 1000))
        )
...
def single_file_savers():
    ...
    dl = get_test_dataloader(scc, ds_name, ds_len=1_000)
...
def all_file_savers():
    ...
    dl = get_test_dataloader(mcc, ds_name, ds_len=1_000)
