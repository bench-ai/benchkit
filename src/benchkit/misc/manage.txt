...
from BenchKit.Miscellaneous.utils.tar import generate_tar
from BenchKit.Miscellaneous.requests.version import upload_project_code
...
def migrate_code(version: int):
    ...
    ts_path = Path(__file__).resolve().parent / "TrainScript.py"
